...
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "emr-serverless-word-count", table_name = "data", transformation_ctx = "datasource0")
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": f"s3://{s3_bucket}/test/data/transformed/green"}, format = "parquet", transformation_ctx = "datasink4")
